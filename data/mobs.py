...
PLAYER = [Info(name="Player", faction=factions.PLAYER), Player(), Inventory(10), Input(), AI(10, PlayerController(), startsReady=True), Damageable(20, PLAYER_BODY), Melee(3), Blocking(), FOV(layout.LEVEL_WIDTH // 2), Velocity(), Renderable("☻", [255,0,0], [0,0,0], renderprio.HIGH), Light((255,255,0), 8, False)]
